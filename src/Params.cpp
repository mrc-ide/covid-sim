...
{
  return Params::get_double(ParamMap(), fallback, params, param_name, default_value, false, P);
}
...
void Params::req_int_vec(ParamMap fallback, ParamMap params,
	                       std::string param_name, int* array, int expected,
	                       Param P) {
	Params::get_int_vec(ParamMap(), fallback, params, param_name, array, expected, 0, 0, false, P, false);
}
...
int Params::req_string_vec(ParamMap fallback, ParamMap params,
	                          std::string param_name, char** array, int expected,
	                          Param P) {
	return Params::req_string_vec(ParamMap(), fallback, params, param_name, array, expected, P);
}
...
void Params::get_double_matrix(ParamMap fallback, ParamMap params,
	...
	Params::get_double_matrix(ParamMap(), fallback, params, param_name, array,
...
void Params::GetInverseCdf(ParamMap fallback, ParamMap params, const char* icdf_name, InverseCdf* inverseCdf, Param P, double start_value)
{
...
void Params::ReadParams(std::string const& ParamFile, std::string const& PreParamFile, std::string const& AdUnitFile,
                        AdminUnit* AdUnits, Param P)
{
	...
	if (P.DoLatent != 0)
	{
		...
		Params::GetInverseCdf(params, pre_params, "Latent period inverse CDF", &P.latent_icdf, P, 1e10);
	}
	...
	if (P.DoSeverity != 0)
	{
		...
		//// Get InverseCDFs
		Params::GetInverseCdf(params, pre_params, "MildToRecovery_icdf", &P.MildToRecovery_icdf, P, ICDF_START);
		Params::GetInverseCdf(params, pre_params, "ILIToRecovery_icdf", &P.ILIToRecovery_icdf, P, ICDF_START);
		Params::GetInverseCdf(params, pre_params, "ILIToDeath_icdf", &P.ILIToDeath_icdf, P, ICDF_START);
		Params::GetInverseCdf(params, pre_params, "SARIToRecovery_icdf", &P.SARIToRecovery_icdf, P, ICDF_START);
		Params::GetInverseCdf(params, pre_params, "CriticalToCritRecov_icdf", &P.CriticalToCritRecov_icdf, P, ICDF_START);
		Params::GetInverseCdf(params, pre_params, "CritRecovToRecov_icdf", &P.CritRecovToRecov_icdf, P, ICDF_START);
		Params::GetInverseCdf(params, pre_params, "ILIToSARI_icdf", &P.ILIToSARI_icdf, P, ICDF_START);
		Params::GetInverseCdf(params, pre_params, "SARIToCritical_icdf", &P.SARIToCritical_icdf, P, ICDF_START);
		Params::GetInverseCdf(params, pre_params, "SARIToDeath_icdf", &P.SARIToDeath_icdf, P, ICDF_START);
		Params::GetInverseCdf(params, pre_params, "CriticalToDeath_icdf", &P.CriticalToDeath_icdf, P, ICDF_START);
		...
		else
		{
			...
			Params::GetInverseCdf(params, pre_params, "StepdownToDeath_icdf", &P.StepdownToDeath_icdf, P, ICDF_START);
		}
