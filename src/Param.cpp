...
{
	int x = (position.x + this->get_number_of_micro_cells_wide()) %
					this->get_number_of_micro_cells_wide();
	int y = (position.y + this->get_number_of_micro_cells_high()) %
					this->get_number_of_micro_cells_high();
