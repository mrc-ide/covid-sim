...
void DoImmune(int);
void DoInfect(int, double, int,
							int); // added int as argument to InfectSweep to record run number: ggilani - 15/10/14
void DoIncub(int, unsigned short int, int,
						 int); // added int as argument to record run number: ggilani - 23/10/14
...
void DoRecover(int, int, int); // added int as argument to record run number: ggilani - 23/10/14.
															 // Added thread number to record Severity categories in StateT.
